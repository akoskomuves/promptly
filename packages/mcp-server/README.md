...
This package provides an MCP (Model Context Protocol) server that integrates with Claude Code to capture conversation turns, token usage, and tool calls during development sessions.
